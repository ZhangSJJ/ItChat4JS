...
var _GlobalInfo = _interopRequireWildcard(require("./GlobalInfo"));
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                url = _GlobalInfo.BASE_URL + "/jslogin";
                _context.next = 3;
                return (0, _Fetch["default"])(url, {
                  appid: _GlobalInfo.APP_ID,
                  json: false
                });
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                now = Date.now();
                url = "".concat(_GlobalInfo.BASE_URL, "/cgi-bin/mmwebwx-bin/login");
                params = {
                  loginicon: true,
                  uuid: userId,
                  tip: 0,
              ...
              case 5:
                ...
                _GlobalInfo.LOGIN_INFO.isLogin = true;
                /***清除循环***/
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                redirectUrl = match[1];
                _GlobalInfo.LOGIN_INFO.redirectUrl = redirectUrl;
                _GlobalInfo.LOGIN_INFO.loginUrl = redirectUrl.slice(0, redirectUrl.lastIndexOf('/'));
                _context3.next = 7;
              ...
              case 7:
                ...
                _GlobalInfo.LOGIN_INFO.cookies = new _nodeJsCookie["default"](cookieArr);
                ...
                _GlobalInfo.LOGIN_INFO['deviceid'] = 'e' + (Math.random() + '').substring(2, 17);
                _GlobalInfo.LOGIN_INFO['logintime'] = Date.now();
                urlInfo.forEach(function (_ref) {
                  ...
                  if (_GlobalInfo.LOGIN_INFO.loginUrl.indexOf(indexUrl) !== -1) {
                    _GlobalInfo.LOGIN_INFO['fileUrl'] = fileUrl;
                    _GlobalInfo.LOGIN_INFO['syncUrl'] = syncUrl;
                  } else {
                    _GlobalInfo.LOGIN_INFO['fileUrl'] = _GlobalInfo.LOGIN_INFO['syncUrl'] = _GlobalInfo.LOGIN_INFO.loginUrl;
                  }
                });
                ...
                _GlobalInfo.LOGIN_INFO.skey = _GlobalInfo.BaseRequest.Skey = skey;
                _GlobalInfo.LOGIN_INFO.wxsid = _GlobalInfo.BaseRequest.Sid = wxsid;
                _GlobalInfo.LOGIN_INFO.wxuin = _GlobalInfo.BaseRequest.Uin = wxuin;
                _GlobalInfo.LOGIN_INFO.pass_ticket = pass_ticket;
                _GlobalInfo.BaseRequest.DeviceID = _GlobalInfo.LOGIN_INFO['deviceid'];
                _context3.next = 24;
                return this.webInit();
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                url = "".concat(_GlobalInfo.LOGIN_INFO['syncUrl'] || _GlobalInfo.LOGIN_INFO.loginUrl, "/synccheck");
                params = {
                  r: Date.now(),
                  skey: _GlobalInfo.LOGIN_INFO['skey'],
                  sid: _GlobalInfo.LOGIN_INFO['wxsid'],
                  uin: _GlobalInfo.LOGIN_INFO['wxuin'],
                  deviceid: _GlobalInfo.LOGIN_INFO['deviceid'],
                  synckey: _GlobalInfo.LOGIN_INFO.syncKeyStr,
                  _: _GlobalInfo.LOGIN_INFO['logintime'],
                  json: false,
                  headers: {
                    cookie: _GlobalInfo.LOGIN_INFO.cookies.getAll((0, _Utils.getUrlDomain)(url))
                  }
                };
                _GlobalInfo.LOGIN_INFO['logintime'] += 1;
                _context5.next = 5;
                return (0, _Fetch["default"])(url, params);
        ...
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                console.log('getmsg');
                url = "".concat(_GlobalInfo.LOGIN_INFO.loginUrl, "/webwxsync?sid=").concat(_GlobalInfo.LOGIN_INFO.wxsid, "&skey=").concat(_GlobalInfo.LOGIN_INFO.skey, "&pass_ticket=").concat(_GlobalInfo.LOGIN_INFO.pass_ticket);
                params = {
                  BaseRequest: _GlobalInfo.BaseRequest,
                  method: 'post',
                  json: false,
                  //为了拿headers更新cookie
                  SyncKey: _GlobalInfo.LOGIN_INFO.syncKey,
                  rr: ~Date.now(),
                  headers: {
                    cookie: _GlobalInfo.LOGIN_INFO.cookies.getAll((0, _Utils.getUrlDomain)(url))
                  }
              ...
              case 5:
                ...
                _GlobalInfo.LOGIN_INFO.cookies.updateCookies(cookieArr);
              ...
              case 13:
                _GlobalInfo.LOGIN_INFO.syncKey = res.SyncKey;
                _GlobalInfo.LOGIN_INFO.syncKeyStr = (res.SyncKey.List || []).map(function (item) {
        ...
        return _regenerator["default"].wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                url = "".concat(_GlobalInfo.LOGIN_INFO.loginUrl, "/webwxsendmsg");
                params = {
                  method: 'post',
                  BaseRequest: (0, _objectSpread2["default"])({}, _GlobalInfo.BaseRequest, {
                    DeviceID: 'e' + (Math.random() + '').substring(2, 17)
                  }),
                  Msg: {
                    Type: msgType,
                    Content: content,
                    FromUserName: _GlobalInfo.LOGIN_INFO.selfUserInfo.UserName,
                    ToUserName: toUserName || _GlobalInfo.LOGIN_INFO.selfUserInfo.UserName,
        ...
        return _regenerator["default"].wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                url = "".concat(_GlobalInfo.LOGIN_INFO.loginUrl, "/webwxstatusnotify?lang=zh_CN&pass_ticket=").concat(_GlobalInfo.LOGIN_INFO.pass_ticket);
                params = {
                  method: 'post',
                  BaseRequest: _GlobalInfo.BaseRequest,
                  Code: 3,
                  FromUserName: _GlobalInfo.LOGIN_INFO.selfUserInfo.UserName,
                  ToUserName: _GlobalInfo.LOGIN_INFO.selfUserInfo.UserName,
        ...
        return _regenerator["default"].wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                now = Date.now();
                url = "".concat(_GlobalInfo.LOGIN_INFO.loginUrl, "/webwxinit?r=").concat(Math.floor(-now / 1579), "&lang=zh_CN&pass_ticket=").concat(_GlobalInfo.LOGIN_INFO.pass_ticket);
                params = {
                  BaseRequest: _GlobalInfo.BaseRequest,
                  method: 'post',
                  headers: {
              ...
              case 5:
                ...
                _GlobalInfo.LOGIN_INFO['InviteStartCount'] = res.InviteStartCount;
                _GlobalInfo.LOGIN_INFO.selfUserInfo = (0, _ConvertData.structFriendInfo)(res.User); // this.contactIns.memberList.push(LOGIN_INFO.selfUserInfo);
...
NodeWeChat.MESSAGE_TYPE = _GlobalInfo.EMIT_NAME;
var NodeWeChatIns = new NodeWeChat();
NodeWeChatIns.run();
NodeWeChatIns.on(NodeWeChat.MESSAGE_TYPE.FRIEND, function (replayInfo, toUserName) {
  console.log('friend', '====================');
  console.log(replayInfo, toUserName);
  var text = replayInfo.text;

  if (text === 'zsj') {
    NodeWeChatIns.sendMsg(1, 'zsssssssj', toUserName);
  }
});
NodeWeChatIns.on(NodeWeChat.MESSAGE_TYPE.CHAT_ROOM, function (replayInfo, toUserName) {
