...
var Message = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Message, [{
    key: "produceGroupMsg",
    value: function () {
      var _produceGroupMsg = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(msg) {
        var reg, match, chatRoomUserName, actualUserName, msgContent, chatRoom, member, myFriend, chatRoomSelfUserInfo, hasSpecialStr, atFlag;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 28:
                if (!member) {
                  ...
                  myFriend = this.getFriendInfo(member.UserName) || {}; // 如果是自己的好友，优先使用RemarkName
    ...
    value: function produceMsg() {
      ...
      msgList.forEach( /*#__PURE__*/function () {
              ...
              switch (_context2.prev = _context2.next) {
                ...
                case 7:
                  ...
                  if (msg['MsgType'] === 1) {
                    ...
                    //picture
                    url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxgetmsgimg");
                    ...
                    //voice
                    _url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxgetvoice");
                    ...
                    //tiny video
                    _url2 = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxgetvideo");
                    ...
                    if (msg['AppMsgType'] === 0) {
                      ...
                      _url4 = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxgetmsgimg");
                  ...
                  msg = _objectSpread(_objectSpread({}, msg), msgInfo);
    ...
    value: function reply(msg) {
      ...
      if (emitName === _GlobalInfo["default"].EMIT_NAME.CHAT_ROOM) {
        retReply = _objectSpread(_objectSpread({}, retReply), {}, {
          isAt: msg['IsAt'],
...
var sendTextMsg = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(msg, toUserName) {
    var url;
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxsendmsg");
...
var sendFile = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(fileDir) {
    var toUserName,
        mediaId,
        streamInfo,
        fileReadStream,
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 20:
            url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxsendappmsg?fun=async&f=json");
...
var sendImage = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(fileDir) {
    var toUserName,
        mediaId,
        streamInfo,
        fileReadStream,
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 20:
            url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxsendmsgimg?fun=async&f=json&lang=").concat(_GlobalInfo["default"].LANG);
            _context6.next = 23;
            return sendMsg({
              url: url,
              msgType: 3,
...
var sendVideo = /*#__PURE__*/function () {
  var _ref7 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(fileDir) {
    var toUserName,
        mediaId,
        streamInfo,
        fileReadStream,
    ...
    return _regenerator["default"].wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 19:
            url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxsendvideomsg?fun=async&f=json&pass_ticket=").concat(_GlobalInfo["default"].LOGIN_INFO.pass_ticket);
            _context7.next = 22;
            return sendMsg({
              url: url,
              msgType: 43,
...
var transmitMsg = /*#__PURE__*/function () {
  var _ref8 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(content, msgType, toUserName) {
    var url, type;
        ...
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            if (msgType === _GlobalInfo["default"].MESSAGE_TYPE.TEXT) {
              ...
              url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxsendmsgimg?fun=async&f=json");
              type = 3;
...
var revokeMsg = /*#__PURE__*/function () {
  var _ref9 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(msgId, toUserName, localId) {
    var url, params, res;
    return _regenerator["default"].wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxrevokemsg");
            params = {
              method: 'post',
              BaseRequest: (0, _Utils.getBaseRequest)(),
...
var uploadChunk = function uploadChunk(_ref12) {
  var buffer = _ref12.buffer,
      ...
      chunk = _ref12.chunk;
  var url = "".concat(_GlobalInfo["default"].LOGIN_INFO.fileUrl || _GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxuploadmedia?f=json");
