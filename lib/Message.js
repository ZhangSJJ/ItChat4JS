...
exports.uploadFile = exports.prepareFile = exports.revokeMsg = exports.sendVideo = exports.sendImage = exports.sendFile = exports.sendTextMsg = exports["default"] = void 0;
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 28:
                if (!member) {
                  (0, _Log.LogDebug)('Chat Room Member Fetch Failed With ' + actualUserName);
                  msg['ActualNickName'] = '';
                  msg['IsAt'] = false;
                } else {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 7:
                  ...
                  _this.reply(msg); // LogDebug(msg['User'].myDefinedUserType + ',' + msg['MsgType'] + ',' + JSON.stringify(msgInfo))
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            (0, _Log.LogDebug)('Request to send a text message to ' + toUserName + ': ' + msg);
            _context4.next = 4;
            return sendMsg({
              url: url,
              msgType: 1,
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            (0, _Log.LogDebug)("Request to send a file(mediaId: ".concat(mediaId, ") to ").concat(toUserName, ": ").concat(fileDir));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            (0, _Log.LogDebug)("Request to send a image(mediaId: ".concat(mediaId, ") to ").concat(toUserName, ": ").concat(fileDir));
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            (0, _Log.LogDebug)("Request to send a video(mediaId: ".concat(mediaId, ") to ").concat(toUserName, ": ").concat(fileDir));
...
function () {
  ...
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee8(msgId, toUserName, localId) {
    var url, params, res;
  ...
  return function revokeMsg(_x9, _x10, _x11) {
...
function () {
  ...
  _regenerator["default"].mark(function _callee9(_ref9) {
    var fileDir, _ref9$isPicture, isPicture, _ref9$isVideo, isVideo, _ref9$toUserName, toUserName, preparedFile, _preparedFile, fileMd5, bufferArr, fileSize, fileSymbol, fileName, fileType, promiseArr;

    return _regenerator["default"].wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            fileDir = _ref9.fileDir, _ref9$isPicture = _ref9.isPicture, isPicture = _ref9$isPicture === void 0 ? false : _ref9$isPicture, _ref9$isVideo = _ref9.isVideo, isVideo = _ref9$isVideo === void 0 ? false : _ref9$isVideo, _ref9$toUserName = _ref9.toUserName, toUserName = _ref9$toUserName === void 0 ? 'filehelper' : _ref9$toUserName, preparedFile = _ref9.preparedFile;
            (0, _Log.LogDebug)("Request to upload a ".concat(isPicture ? 'picture' : isVideo ? 'video' : 'file', ": ").concat(fileDir));
            _context9.t0 = preparedFile;
          ...
          case 12:
            ...
            return _context9.abrupt("return", promiseArr.reduce(function (result, next) {
  ...
  return function uploadFile(_x12) {
...
var uploadChunk = function uploadChunk(_ref11) {
  var buffer = _ref11.buffer,
      fileMd5 = _ref11.fileMd5,
      fileSymbol = _ref11.fileSymbol,
      totalFileSize = _ref11.totalFileSize,
      fileName = _ref11.fileName,
      fileType = _ref11.fileType,
      toUserName = _ref11.toUserName,
      chunks = _ref11.chunks,
      chunk = _ref11.chunk;
  ...
  return function () {
    ...
    (0, _Log.LogDebug)("Request to upload a chunk ".concat(fileSymbol, ", chunks: ").concat(chunks, ", chunk: ").concat(chunk, " to: ").concat(toUserName));
