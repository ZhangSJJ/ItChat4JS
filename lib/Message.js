...
function () {
  ...
  _regenerator["default"].mark(function _callee9(_ref9) {
    var fileDir, _ref9$isPicture, isPicture, _ref9$isVideo, isVideo, _ref9$toUserName, toUserName, preparedFile, url, _preparedFile, fileMd5, buffer, fileSize, fileSymbol, fileName, fileType, uploadMediaRequest, webwxDataTicket, formData, dataJson, res;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 6;
            return prepareFile(fileDir, fileStream);
          ...
          case 11:
            url = "".concat(_GlobalInfo["default"].LOGIN_INFO.fileUrl || _GlobalInfo["default"].LOGIN_INFO.loginUrl, "/webwxuploadmedia?f=json");
            _preparedFile = preparedFile, fileMd5 = _preparedFile.fileMd5, buffer = _preparedFile.buffer, fileSize = _preparedFile.fileSize;
            fileSymbol = 'doc';
            ...
            webwxDataTicket = _GlobalInfo["default"].LOGIN_INFO.cookies.getValue('webwx_data_ticket', (0, _Utils.getUrlDomain)(url));
