          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                url = "".concat(_GlobalInfo.LOGIN_INFO.loginUrl, "/webwxbatchgetcontact?type=ex&r=").concat(Date.now());
                params = {
                  method: 'POST',
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                seq = _args4.length > 0 && _args4[0] !== undefined ? _args4[0] : 0;
                url = "".concat(_GlobalInfo.LOGIN_INFO.loginUrl, "/webwxgetcontact?r=").concat(Date.now(), "&seq=").concat(seq, "&skey=").concat(_GlobalInfo.LOGIN_INFO['skey']);
                return _context4.abrupt("return", (0, _Fetch["default"])(url, {
                  headers: {
                    cookie: _GlobalInfo.LOGIN_INFO.cookies.getAll((0, _Utils.getUrlDomain)(url))
                  }
                }));
    ...
    value: function updateLocalChatRoom() {
      ...
      roomList.forEach(function (chatRoom) {
        ...
        if (!!oldChatRoom.OwnerUin) {
          oldChatRoom.IsAdmin = oldChatRoom.OwnerUin === _GlobalInfo.LOGIN_INFO['wxuin'];
        } //update Self


        var newSelf = oldMemberList.find(function (i) {
          return i.UserName === _GlobalInfo.LOGIN_INFO.selfUserInfo.UserName;
        });
        oldChatRoom['Self'] = newSelf || (0, _Utils.deepClone)(_GlobalInfo.LOGIN_INFO['User']);
      });
