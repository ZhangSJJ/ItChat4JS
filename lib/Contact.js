...
var Contact = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Contact, [{
    key: "clearContactList",
    value: function clearContactList() {
      this.chatRoomList = [];
      this.memberList = [];
      this.mpList = [];
    }
    ...
    key: "getContact",
    value: function () {
      var _getContact = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2() {
        var _this = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                batchFetchContact = /*#__PURE__*/function () {
    ...
    value: function getChatRoomInfo(chatRoomUserName) {
      ...
      var filterRet = this.chatRoomList.filter(function (i) {
        return chatRoomUserName.indexOf(i.UserName) !== -1 || chatRoomUserName.indexOf(i.NickName) !== -1 || chatRoomUserName.indexOf(i.RemarkName) !== -1;
      });
    ...
    value: function getFriendInfo(userName) {
      ...
      var filterRet = this.memberList.filter(function (i) {
        return userName.indexOf(i.UserName) !== -1 || userName.indexOf(i.NickName) !== -1 || userName.indexOf(i.RemarkName) !== -1;
      });
    ...
    value: function () {
      var _updateChatRoomInfo = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(userName) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxbatchgetcontact?type=ex&r=").concat(Date.now());
                params = {
                  method: 'POST',
    ...
    value: function () {
      var _updateFriendInfo = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(userName) {
        var url, params, res;
    ...
    key: "getContactList",
    value: function () {
      var _getContactList = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5() {
        var seq,
            url,
            _args5 = arguments;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxgetcontact?r=").concat(Date.now(), "&seq=").concat(seq, "&skey=").concat(_GlobalInfo["default"].LOGIN_INFO['skey']);
    ...
    value: function updateLocalChatRoom() {
      ...
      roomList.forEach(function (chatRoom) {
        ...
        (0, _Utils.emojiFormatter)(chatRoom, 'NickName');
        (chatRoom.memberList || []).forEach(function (member) {
          (0, _Utils.emojiFormatter)(member, 'NickName');
          (0, _Utils.emojiFormatter)(member, 'DisplayName');
          (0, _Utils.emojiFormatter)(member, 'RemarkName');
        });
    ...
    value: function updateLocalFriends() {
      ...
      friendList.forEach(function (friend) {
        (0, _Utils.emojiFormatter)(friend, 'NickName');
        (0, _Utils.emojiFormatter)(friend, 'DisplayName');
        (0, _Utils.emojiFormatter)(friend, 'RemarkName');
    ...
    value: function updateContactList() {
      var contactList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var chatRoomList = [],
          otherList = [];
    ...
    key: "deleteContactList",
    value: function deleteContactList() {
      var _this4 = this;

      var delContactList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var chatRoomList = [],
          otherList = [];
      delContactList.forEach(function (item) {
        if (item.Sex !== 0) {
          otherList.push(item);
        } else if (item.UserName.indexOf('@@') !== -1) {
          item.MemberList = [];
      ...
      if (otherList.length) {
        // 好友列表 + 订阅号以及公众号
        var fullList = this.memberList.concat(this.mpList);
        otherList.forEach(function (deleteFriend) {
          var deleteUseInfo = fullList.find(function (i) {
            return i.UserName === deleteFriend['UserName'];
          });

          if (deleteUseInfo) {
            if ((deleteUseInfo['VerifyFlag'] & 8) === 0) {
              _this4.memberList = _this4.memberList.filter(function (i) {
                return i.UserName !== deleteFriend['UserName'];
              });
            } else {
              _this4.mpList = _this4.mpList.filter(function (i) {
                return i.UserName !== deleteFriend['UserName'];
              });
            }
          }
    ...
    value: function updateLocalUin(msg) {
      ...
      if (match && match[1]) {
        ...
        if (!!uins.length && !!usernames.length && uins.length === usernames.length) {
          uins.forEach( /*#__PURE__*/function () {
            var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(uin, index) {
              ...
              return _regenerator["default"].wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 3:
                      userInfo = _this5.getContactInfoByName(username);
                      ...
                      if ((userInfo['Uin'] || 0) === 0) {
                        ...
                        (0, _Log.LogInfo)('Uin fetched: ' + username + ', ' + uin);
                      } else if (userInfo['Uin'] !== uin) {
                        (0, _Log.LogInfo)('Uin changed: ' + userInfo['Uin'] + ', ' + uin);
                      }
                    ...
                    case 8:
                      ...
                      _context6.next = 11;
                      return _this5.updateChatRoomInfo(username);

                    case 11:
                      newChatRoomInfo = _this5.getChatRoomInfo(username);
                      ...
                      if (!newChatRoomInfo) {
                        ...
                        _this5.chatRoomList.push(newChatRoomInfo);
                      } else {
                    ...
                    case 15:
                      ...
                      _context6.next = 18;
                      return _this5.updateFriendInfo(username);

                    case 18:
                      newFriendInfo = _this5.getFriendInfo(username);
                      ...
                      if (!newFriendInfo) {
                        ...
                        _this5.memberList.push(newFriendInfo);
                      } else {
          ...
          (0, _Log.LogInfo)('Wrong length of uins & usernames: ' + uins.length + ',' + usernames.length);
        }
      } else {
        (0, _Log.LogInfo)('No uins in 51 message');
        (0, _Log.LogInfo)(msg['Content']);
      }
    ...
    key: "verifyFriend",
    value: function () {
      var _verifyFriend = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(userName) {
        var status,
            verifyContent,
            autoUpdate,
            url,
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                (0, _Log.LogInfo)('Add a friend or accept a friend');
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxverifyuser");
                params = {
                  method: 'post',
                  r: Date.now(),
    ...
    key: "setAlias",
    value: function () {
      var _setAlias = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(userName) {
        var alias,
            oldFriendInfo,
            url,
            params,
        ...
        return _regenerator["default"].wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 5:
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxoplog?lang=zh_CN&pass_ticket=").concat(_GlobalInfo["default"].LOGIN_INFO.pass_ticket);
                params = {
                  method: 'post',
                  UserName: userName,
                  CmdId: 2,
    ...
    key: "setPinned",
    value: function () {
      var _setPinned = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(userName) {
        var isPinned,
            oldFriendInfo,
            url,
            params,
        ...
        return _regenerator["default"].wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 5:
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxoplog?pass_ticket=").concat(_GlobalInfo["default"].LOGIN_INFO.pass_ticket);
                params = {
                  method: 'post',
                  UserName: userName,
                  CmdId: 3,
    ...
    key: "createChatRoom",
    value: function () {
      var _createChatRoom = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10(memberList) {
        var topic,
            url,
            params,
            _args10 = arguments;
        return _regenerator["default"].wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 4:
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxcreatechatroom?pass_ticket=").concat(_GlobalInfo["default"].LOGIN_INFO.pass_ticket, "&r=").concat(Date.now());
                params = {
                  method: 'post',
                  BaseRequest: (0, _Utils.getBaseRequest)(),
    ...
    key: "setChatRoomName",
    value: function () {
      var _setChatRoomName = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11(chatRoomUserName, name) {
        ...
        return _regenerator["default"].wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 4:
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxupdatechatroom?fun=modtopic&pass_ticket=").concat(_GlobalInfo["default"].LOGIN_INFO.pass_ticket);
                params = {
                  method: 'post',
                  BaseRequest: (0, _Utils.getBaseRequest)(),
    ...
    value: function () {
      var _deleteMemberFromChatRoom = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee12(chatRoomUserName, memberList) {
        var oldChatRoomInfo, url, params;
        return _regenerator["default"].wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 5:
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxupdatechatroom?fun=delmember&lang=zh_CN&pass_ticket=").concat(_GlobalInfo["default"].LOGIN_INFO.pass_ticket);
                params = {
                  method: 'post',
                  BaseRequest: (0, _Utils.getBaseRequest)(),
                  ChatRoomName: chatRoomUserName,
    ...
    value: function () {
      var _addMemberIntoChatRoom = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee13(chatRoomUserName, memberList) {
        var _params;
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 10:
                ...
                url = "".concat(_GlobalInfo["default"].LOGIN_INFO.hostUrl, "/webwxupdatechatroom?fun=").concat(fun, "&pass_ticket=").concat(_GlobalInfo["default"].LOGIN_INFO.pass_ticket);
                params = (_params = {
                  method: 'post',
                  BaseRequest: (0, _Utils.getBaseRequest)(),
                  ChatRoomName: chatRoomUserName
